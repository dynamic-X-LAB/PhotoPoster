...
class StableDiffusionControlNetInpaintPipeline(
    ...
    def __call__(
        ...
        control_image2: PipelineImageInput = None,
        ...
        **kwargs,
        ...
        # 4. Prepare image
        if isinstance(controlnet, ControlNetModel):
            control_image1 = self.prepare_control_image(
                image=control_image,
                width=width,
                height=height,
            ...
            control_image2 = self.prepare_control_image(
            ...
            # control_image = torch.cat([control_image1, control_image2], dim=1)
        ...
        if target_image is not None:
            init_tgt_image = self.image_processor.preprocess(target_image, height=height, width=width)
            init_tgt_image = init_tgt_image.to(dtype=torch.float32)
        ...
        latents_outputs = self.prepare_latents(
            ...
            generator,
            latents,
            image=init_image if target_image is None else init_tgt_image, 
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                down_block_res_samples, mid_block_res_sample = self.controlnet(
                    ...
                    controlnet_cond1=control_image1,
                    controlnet_cond2=control_image2,
